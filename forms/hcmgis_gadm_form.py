...
class Ui_hcmgis_gadm_form(object):
    def setupUi(self, hcmgis_gadm_form):
        ...
        hcmgis_gadm_form.setWindowModality(QtCore.Qt.WindowModality.ApplicationModal)
        ...
        self.label = QtWidgets.QLabel(parent=hcmgis_gadm_form)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_2 = QtWidgets.QLabel(parent=hcmgis_gadm_form)
        self.label_2.setObjectName("label_2")
        self.gridLayout.addWidget(self.label_2, 2, 0, 1, 1)
        self.cboCountry = QtWidgets.QComboBox(parent=hcmgis_gadm_form)
        self.cboCountry.setObjectName("cboCountry")
        self.gridLayout.addWidget(self.cboCountry, 1, 1, 1, 1)
        self.label_3 = QtWidgets.QLabel(parent=hcmgis_gadm_form)
        self.label_3.setObjectName("label_3")
        self.gridLayout.addWidget(self.label_3, 1, 0, 1, 1)
        self.LinLOD = QtWidgets.QLineEdit(parent=hcmgis_gadm_form)
        ...
        self.LinOutputFolder = QtWidgets.QLineEdit(parent=hcmgis_gadm_form)
        ...
        self.BtnApplyClose.accepted.connect(hcmgis_gadm_form.accept) # type: ignore
        self.BtnApplyClose.rejected.connect(hcmgis_gadm_form.reject) # type: ignore

...
class Ui_hcmgis_geofabrik_form(object):
    def setupUi(self, hcmgis_geofabrik_form):
        ...
        hcmgis_geofabrik_form.setWindowModality(QtCore.Qt.WindowModality.ApplicationModal)
        ...
        self.label = QtWidgets.QLabel(parent=hcmgis_geofabrik_form)
        font = QtGui.QFont()
        font.setBold(True)
        self.label.setFont(font)
        self.label.setObjectName("label")
        self.gridLayout.addWidget(self.label, 0, 0, 1, 2)
        self.label_3 = QtWidgets.QLabel(parent=hcmgis_geofabrik_form)
        self.label_3.setObjectName("label_3")
        self.gridLayout.addWidget(self.label_3, 6, 0, 1, 1)
        self.label_2 = QtWidgets.QLabel(parent=hcmgis_geofabrik_form)
        self.label_2.setObjectName("label_2")
        self.gridLayout.addWidget(self.label_2, 3, 0, 1, 1)
        self.cboRegion = QtWidgets.QComboBox(parent=hcmgis_geofabrik_form)
        self.cboRegion.setObjectName("cboRegion")
        self.gridLayout.addWidget(self.cboRegion, 3, 1, 1, 1)
        self.cboCountry = QtWidgets.QComboBox(parent=hcmgis_geofabrik_form)
        self.cboCountry.setObjectName("cboCountry")
        self.gridLayout.addWidget(self.cboCountry, 6, 1, 1, 1)
        self.label_4 = QtWidgets.QLabel(parent=hcmgis_geofabrik_form)
        self.label_4.setObjectName("label_4")
        self.gridLayout.addWidget(self.label_4, 7, 0, 1, 1)
        self.cboProvince = QtWidgets.QComboBox(parent=hcmgis_geofabrik_form)
        ...
        self.LinOutputFolder = QtWidgets.QLineEdit(parent=hcmgis_geofabrik_form)
        ...
        self.BtnOutputFolder = QtWidgets.QPushButton(parent=hcmgis_geofabrik_form)
        self.BtnOutputFolder.setObjectName("BtnOutputFolder")
        self.gridLayout_2.addWidget(self.BtnOutputFolder, 1, 1, 1, 1)
        self.status = QtWidgets.QProgressBar(parent=hcmgis_geofabrik_form)
        self.status.setProperty("value", 24)
        self.status.setObjectName("status")
        self.gridLayout_2.addWidget(self.status, 3, 0, 1, 2)
        self.LblStatus = QtWidgets.QLabel(parent=hcmgis_geofabrik_form)
        self.LblStatus.setText("")
        self.LblStatus.setObjectName("LblStatus")
        self.gridLayout_2.addWidget(self.LblStatus, 2, 0, 1, 2)
        self.verticalLayout.addLayout(self.gridLayout_2)
        self.BtnApplyClose = QtWidgets.QDialogButtonBox(parent=hcmgis_geofabrik_form)
        ...
        self.BtnApplyClose.accepted.connect(hcmgis_geofabrik_form.accept) # type: ignore
        self.BtnApplyClose.rejected.connect(hcmgis_geofabrik_form.reject) # type: ignore

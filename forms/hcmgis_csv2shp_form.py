...
class Ui_hcmgis_csv2shp_form(object):
    def setupUi(self, hcmgis_csv2shp_form):
        ...
        hcmgis_csv2shp_form.setWindowModality(QtCore.Qt.WindowModality.ApplicationModal)
        ...
        self.label_2 = QtWidgets.QLabel(parent=hcmgis_csv2shp_form)
        ...
        self.BtnInputFolder = QtWidgets.QPushButton(parent=hcmgis_csv2shp_form)
        ...
        self.LinInputFolder = QtWidgets.QLineEdit(parent=hcmgis_csv2shp_form)
        ...
        self.lblCSV = QtWidgets.QLabel(parent=hcmgis_csv2shp_form)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.lblCSV.setFont(font)
        self.lblCSV.setText("")
        self.lblCSV.setAlignment(QtCore.Qt.AlignmentFlag.AlignBottom|QtCore.Qt.AlignmentFlag.AlignLeading|QtCore.Qt.AlignmentFlag.AlignLeft)
        self.lblCSV.setObjectName("lblCSV")
        self.verticalLayout.addWidget(self.lblCSV)
        self.lsCSV = QtWidgets.QListWidget(parent=hcmgis_csv2shp_form)
        self.lsCSV.setObjectName("lsCSV")
        self.verticalLayout.addWidget(self.lsCSV)
        self.gridLayout_2 = QtWidgets.QGridLayout()
        self.gridLayout_2.setObjectName("gridLayout_2")
        self.longitude_field = QtWidgets.QComboBox(parent=hcmgis_csv2shp_form)
        self.longitude_field.setObjectName("longitude_field")
        self.gridLayout_2.addWidget(self.longitude_field, 1, 1, 1, 1)
        self.label_7 = QtWidgets.QLabel(parent=hcmgis_csv2shp_form)
        self.label_7.setObjectName("label_7")
        self.gridLayout_2.addWidget(self.label_7, 0, 1, 1, 1)
        self.latitude_field = QtWidgets.QComboBox(parent=hcmgis_csv2shp_form)
        self.latitude_field.setObjectName("latitude_field")
        self.gridLayout_2.addWidget(self.latitude_field, 1, 0, 1, 1)
        self.label_8 = QtWidgets.QLabel(parent=hcmgis_csv2shp_form)
        self.label_8.setObjectName("label_8")
        self.gridLayout_2.addWidget(self.label_8, 0, 0, 1, 1)
        self.verticalLayout.addLayout(self.gridLayout_2)
        self.LblStatus = QtWidgets.QLabel(parent=hcmgis_csv2shp_form)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.status = QtWidgets.QProgressBar(parent=hcmgis_csv2shp_form)
        self.status.setProperty("value", 24)
        self.status.setObjectName("status")
        self.verticalLayout.addWidget(self.status)
        self.label = QtWidgets.QLabel(parent=hcmgis_csv2shp_form)
        self.label.setObjectName("label")
        self.verticalLayout.addWidget(self.label)
        self.txtError = QtWidgets.QTextEdit(parent=hcmgis_csv2shp_form)
        self.txtError.setObjectName("txtError")
        self.verticalLayout.addWidget(self.txtError)
        self.BtnApplyClose = QtWidgets.QDialogButtonBox(parent=hcmgis_csv2shp_form)
        ...
        self.BtnApplyClose.accepted.connect(hcmgis_csv2shp_form.accept) # type: ignore
        self.BtnApplyClose.rejected.connect(hcmgis_csv2shp_form.reject) # type: ignore

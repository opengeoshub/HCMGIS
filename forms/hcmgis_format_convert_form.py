...
class Ui_hcmgis_format_convert_form(object):
    def setupUi(self, hcmgis_format_convert_form):
        ...
        hcmgis_format_convert_form.setWindowModality(QtCore.Qt.WindowModality.ApplicationModal)
        ...
        self.cboOutputFormat = QtWidgets.QComboBox(parent=hcmgis_format_convert_form)
        ...
        self.label_7 = QtWidgets.QLabel(parent=hcmgis_format_convert_form)
        self.label_7.setObjectName("label_7")
        self.gridLayout_2.addWidget(self.label_7, 0, 4, 1, 1)
        self.label_8 = QtWidgets.QLabel(parent=hcmgis_format_convert_form)
        self.label_8.setObjectName("label_8")
        self.gridLayout_2.addWidget(self.label_8, 0, 0, 1, 1)
        self.cboInputFormat = QtWidgets.QComboBox(parent=hcmgis_format_convert_form)
        ...
        self.label_2 = QtWidgets.QLabel(parent=hcmgis_format_convert_form)
        ...
        self.BtnInputFolder = QtWidgets.QPushButton(parent=hcmgis_format_convert_form)
        ...
        self.LinInputFolder = QtWidgets.QLineEdit(parent=hcmgis_format_convert_form)
        self.LinInputFolder.setEnabled(True)
        self.LinInputFolder.setMouseTracking(True)
        self.LinInputFolder.setFocusPolicy(QtCore.Qt.FocusPolicy.NoFocus)
        ...
        self.lblFiles = QtWidgets.QLabel(parent=hcmgis_format_convert_form)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.lblFiles.setFont(font)
        self.lblFiles.setText("")
        self.lblFiles.setAlignment(QtCore.Qt.AlignmentFlag.AlignBottom|QtCore.Qt.AlignmentFlag.AlignLeading|QtCore.Qt.AlignmentFlag.AlignLeft)
        self.lblFiles.setObjectName("lblFiles")
        self.verticalLayout.addWidget(self.lblFiles)
        self.lsFiles = QtWidgets.QListWidget(parent=hcmgis_format_convert_form)
        self.lsFiles.setObjectName("lsFiles")
        self.verticalLayout.addWidget(self.lsFiles)
        self.LblStatus = QtWidgets.QLabel(parent=hcmgis_format_convert_form)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.status = QtWidgets.QProgressBar(parent=hcmgis_format_convert_form)
        self.status.setProperty("value", 24)
        self.status.setObjectName("status")
        self.verticalLayout.addWidget(self.status)
        self.label = QtWidgets.QLabel(parent=hcmgis_format_convert_form)
        self.label.setObjectName("label")
        self.verticalLayout.addWidget(self.label)
        self.txtError = QtWidgets.QTextEdit(parent=hcmgis_format_convert_form)
        self.txtError.setObjectName("txtError")
        self.verticalLayout.addWidget(self.txtError)
        self.BtnApplyClose = QtWidgets.QDialogButtonBox(parent=hcmgis_format_convert_form)
        ...
        self.BtnApplyClose.accepted.connect(hcmgis_format_convert_form.accept) # type: ignore
        self.BtnApplyClose.rejected.connect(hcmgis_format_convert_form.reject) # type: ignore

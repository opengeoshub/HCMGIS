...
class Ui_hcmgis_customprojections_form(object):
    def setupUi(self, hcmgis_customprojections_form):
        ...
        hcmgis_customprojections_form.setWindowModality(QtCore.Qt.WindowModality.ApplicationModal)
        ...
        self.LblEPSGInfo = QtWidgets.QLabel(parent=hcmgis_customprojections_form)
        self.LblEPSGInfo.setObjectName("LblEPSGInfo")
        self.gridLayout.addWidget(self.LblEPSGInfo, 9, 0, 1, 4)
        self.label = QtWidgets.QLabel(parent=hcmgis_customprojections_form)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.radProvinces = QtWidgets.QRadioButton(parent=hcmgis_customprojections_form)
        ...
        self.cboProvinces = QtWidgets.QComboBox(parent=hcmgis_customprojections_form)
        ...
        self.TxtEPSGInfo = QtWidgets.QTextEdit(parent=hcmgis_customprojections_form)
        ...
        self.radEPSG = QtWidgets.QRadioButton(parent=hcmgis_customprojections_form)
        self.radEPSG.setObjectName("radEPSG")
        self.gridLayout.addWidget(self.radEPSG, 1, 2, 1, 1)
        self.cboEPSG = QtWidgets.QComboBox(parent=hcmgis_customprojections_form)
        ...
        self.BtnClose = QtWidgets.QDialogButtonBox(parent=hcmgis_customprojections_form)
        self.BtnClose.setStandardButtons(QtWidgets.QDialogButtonBox.StandardButton.Close)
        self.BtnClose.setObjectName("BtnClose")
        self.verticalLayout.addWidget(self.BtnClose)

        self.retranslateUi(hcmgis_customprojections_form)
        self.BtnClose.accepted.connect(hcmgis_customprojections_form.accept) # type: ignore
        self.BtnClose.rejected.connect(hcmgis_customprojections_form.reject) # type: ignore

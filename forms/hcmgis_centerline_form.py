...
class Ui_hcmgis_centerline_form(object):
    def setupUi(self, hcmgis_centerline_form):
        ...
        hcmgis_centerline_form.setWindowModality(QtCore.Qt.WindowModality.ApplicationModal)
        ...
        self.spinBox = QgsDoubleSpinBox(parent=hcmgis_centerline_form)
        ...
        self.status = QtWidgets.QProgressBar(parent=hcmgis_centerline_form)
        self.status.setProperty("value", 24)
        self.status.setObjectName("status")
        self.gridLayout.addWidget(self.status, 11, 0, 1, 2)
        self.CboInput = QgsMapLayerComboBox(parent=hcmgis_centerline_form)
        ...
        self.LblOutput = QtWidgets.QLabel(parent=hcmgis_centerline_form)
        self.LblOutput.setObjectName("LblOutput")
        self.gridLayout.addWidget(self.LblOutput, 8, 0, 1, 2)
        self.label = QtWidgets.QLabel(parent=hcmgis_centerline_form)
        font = QtGui.QFont()
        font.setBold(False)
        font.setItalic(True)
        font.setWeight(50)
        ...
        self.LblStatus = QtWidgets.QLabel(parent=hcmgis_centerline_form)
        self.LblStatus.setText("")
        self.LblStatus.setObjectName("LblStatus")
        self.gridLayout.addWidget(self.LblStatus, 10, 0, 1, 2)
        self.LblInput_2 = QtWidgets.QLabel(parent=hcmgis_centerline_form)
        self.LblInput_2.setObjectName("LblInput_2")
        self.gridLayout.addWidget(self.LblInput_2, 2, 0, 1, 2)
        self.distance = QgsDoubleSpinBox(parent=hcmgis_centerline_form)
        self.distance.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignTrailing|QtCore.Qt.AlignmentFlag.AlignVCenter)
        ...
        self.BtnApplyClose = QtWidgets.QDialogButtonBox(parent=hcmgis_centerline_form)
        ...
        self.BtnApplyClose.accepted.connect(hcmgis_centerline_form.accept) # type: ignore
        self.BtnApplyClose.rejected.connect(hcmgis_centerline_form.reject) # type: ignore

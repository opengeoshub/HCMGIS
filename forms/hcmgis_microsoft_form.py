...
class Ui_hcmgis_microsoft_form(object):
    def setupUi(self, hcmgis_microsoft_form):
        ...
        hcmgis_microsoft_form.setWindowModality(QtCore.Qt.WindowModality.ApplicationModal)
        ...
        self.LblBuildings = QtWidgets.QLabel(parent=hcmgis_microsoft_form)
        self.LblBuildings.setObjectName("LblBuildings")
        self.gridLayout.addWidget(self.LblBuildings, 7, 0, 1, 1)
        self.label_3 = QtWidgets.QLabel(parent=hcmgis_microsoft_form)
        self.label_3.setObjectName("label_3")
        self.gridLayout.addWidget(self.label_3, 5, 0, 1, 1)
        self.label_4 = QtWidgets.QLabel(parent=hcmgis_microsoft_form)
        self.label_4.setObjectName("label_4")
        self.gridLayout.addWidget(self.label_4, 6, 0, 1, 1)
        self.LinBuidings = QtWidgets.QLineEdit(parent=hcmgis_microsoft_form)
        ...
        self.LinSize = QtWidgets.QLineEdit(parent=hcmgis_microsoft_form)
        self.LinSize.setReadOnly(True)
        self.LinSize.setObjectName("LinSize")
        self.gridLayout.addWidget(self.LinSize, 7, 3, 1, 1)
        self.verticalLayout.addLayout(self.gridLayout)
        self.LblHyperlink = QtWidgets.QLabel(parent=hcmgis_microsoft_form)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.status = QtWidgets.QProgressBar(parent=hcmgis_microsoft_form)
        self.status.setProperty("value", 24)
        self.status.setObjectName("status")
        self.gridLayout_2.addWidget(self.status, 3, 0, 1, 2)
        self.LinOutputFolder = QtWidgets.QLineEdit(parent=hcmgis_microsoft_form)
        ...
        self.LblStatus = QtWidgets.QLabel(parent=hcmgis_microsoft_form)
        self.LblStatus.setText("")
        self.LblStatus.setObjectName("LblStatus")
        self.gridLayout_2.addWidget(self.LblStatus, 2, 0, 1, 2)
        self.BtnOutputFolder = QtWidgets.QPushButton(parent=hcmgis_microsoft_form)
        self.BtnOutputFolder.setObjectName("BtnOutputFolder")
        self.gridLayout_2.addWidget(self.BtnOutputFolder, 1, 1, 1, 1)
        self.verticalLayout.addLayout(self.gridLayout_2)
        self.BtnApplyClose = QtWidgets.QDialogButtonBox(parent=hcmgis_microsoft_form)
        ...
        self.BtnApplyClose.accepted.connect(hcmgis_microsoft_form.accept) # type: ignore
        self.BtnApplyClose.rejected.connect(hcmgis_microsoft_form.reject) # type: ignore

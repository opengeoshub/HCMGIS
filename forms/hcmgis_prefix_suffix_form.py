...
class Ui_hcmgis_prefix_suffix_form(object):
    def setupUi(self, hcmgis_prefix_suffix_form):
        ...
        hcmgis_prefix_suffix_form.setWindowModality(QtCore.Qt.WindowModality.ApplicationModal)
        ...
        self.LblInput = QtWidgets.QLabel(parent=hcmgis_prefix_suffix_form)
        self.LblInput.setObjectName("LblInput")
        self.verticalLayout.addWidget(self.LblInput)
        self.CboInput = QgsMapLayerComboBox(parent=hcmgis_prefix_suffix_form)
        self.CboInput.setObjectName("CboInput")
        self.verticalLayout.addWidget(self.CboInput)
        self.LblOutput_2 = QtWidgets.QLabel(parent=hcmgis_prefix_suffix_form)
        self.LblOutput_2.setObjectName("LblOutput_2")
        self.verticalLayout.addWidget(self.LblOutput_2)
        self.CboField = QgsFieldComboBox(parent=hcmgis_prefix_suffix_form)
        ...
        self.LblChar = QtWidgets.QLabel(parent=hcmgis_prefix_suffix_form)
        self.LblChar.setObjectName("LblChar")
        self.gridLayout.addWidget(self.LblChar, 0, 0, 1, 1)
        self.LblChar_3 = QtWidgets.QLabel(parent=hcmgis_prefix_suffix_form)
        self.LblChar_3.setObjectName("LblChar_3")
        self.gridLayout.addWidget(self.LblChar_3, 0, 1, 1, 1)
        self.LinPrefix = QtWidgets.QLineEdit(parent=hcmgis_prefix_suffix_form)
        self.LinPrefix.setObjectName("LinPrefix")
        self.gridLayout.addWidget(self.LinPrefix, 1, 0, 1, 1)
        self.CboCharPrefix = QtWidgets.QComboBox(parent=hcmgis_prefix_suffix_form)
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.LblChar_2 = QtWidgets.QLabel(parent=hcmgis_prefix_suffix_form)
        self.LblChar_2.setObjectName("LblChar_2")
        self.gridLayout.addWidget(self.LblChar_2, 2, 0, 1, 1)
        self.LblChar_4 = QtWidgets.QLabel(parent=hcmgis_prefix_suffix_form)
        self.LblChar_4.setObjectName("LblChar_4")
        self.gridLayout.addWidget(self.LblChar_4, 2, 1, 1, 1)
        self.LinSuffix = QtWidgets.QLineEdit(parent=hcmgis_prefix_suffix_form)
        self.LinSuffix.setObjectName("LinSuffix")
        self.gridLayout.addWidget(self.LinSuffix, 3, 0, 1, 1)
        self.CboCharSuffix = QtWidgets.QComboBox(parent=hcmgis_prefix_suffix_form)
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.ChkSelectedFeaturesOnly = QtWidgets.QCheckBox(parent=hcmgis_prefix_suffix_form)
        ...
        self.BtnOKCancel = QtWidgets.QDialogButtonBox(parent=hcmgis_prefix_suffix_form)
        ...
        self.BtnOKCancel.accepted.connect(hcmgis_prefix_suffix_form.accept) # type: ignore
        self.BtnOKCancel.rejected.connect(hcmgis_prefix_suffix_form.reject) # type: ignore

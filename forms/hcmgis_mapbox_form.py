...
class Ui_hcmgis_mapbox_form(object):
    def setupUi(self, hcmgis_mapbox_form):
        ...
        hcmgis_mapbox_form.setWindowModality(QtCore.Qt.WindowModality.ApplicationModal)
        ...
        self.LblMapboxStyle = QtWidgets.QLabel(parent=hcmgis_mapbox_form)
        self.LblMapboxStyle.setObjectName("LblMapboxStyle")
        self.gridLayout.addWidget(self.LblMapboxStyle, 1, 0, 1, 1)
        self.radProvinces = QtWidgets.QRadioButton(parent=hcmgis_mapbox_form)
        ...
        self.CboStyleType = QtWidgets.QComboBox(parent=hcmgis_mapbox_form)
        self.CboStyleType.setObjectName("CboStyleType")
        self.CboStyleType.addItem("")
        self.CboStyleType.addItem("")
        self.gridLayout.addWidget(self.CboStyleType, 0, 1, 1, 3)
        self.LblSignUp = QtWidgets.QLabel(parent=hcmgis_mapbox_form)
        font = QtGui.QFont()
        font.setBold(True)
        ...
        self.CboMapboxStyle = QtWidgets.QComboBox(parent=hcmgis_mapbox_form)
        ...
        self.BtnApplyClose = QtWidgets.QDialogButtonBox(parent=hcmgis_mapbox_form)
        ...
        self.BtnApplyClose.accepted.connect(hcmgis_mapbox_form.accept) # type: ignore
        self.BtnApplyClose.rejected.connect(hcmgis_mapbox_form.reject) # type: ignore

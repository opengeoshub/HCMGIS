...
class Ui_hcmgis_find_replace_form(object):
    def setupUi(self, hcmgis_find_replace_form):
        ...
        hcmgis_find_replace_form.setWindowModality(QtCore.Qt.WindowModality.ApplicationModal)
        ...
        self.BtnOKCancel = QtWidgets.QDialogButtonBox(parent=hcmgis_find_replace_form)
        ...
        self.BtnOKCancel.accepted.connect(hcmgis_find_replace_form.accept) # type: ignore
        self.BtnOKCancel.rejected.connect(hcmgis_find_replace_form.reject) # type: ignore

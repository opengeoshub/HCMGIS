...
class Ui_hcmgis_fixgeometries_form(object):
    def setupUi(self, hcmgis_fixgeometries_form):
        ...
        hcmgis_fixgeometries_form.setWindowModality(QtCore.Qt.WindowModality.ApplicationModal)
        ...
        self.LblInput = QtWidgets.QLabel(parent=hcmgis_fixgeometries_form)
        self.LblInput.setObjectName("LblInput")
        self.verticalLayout.addWidget(self.LblInput)
        self.CboInput = QgsMapLayerComboBox(parent=hcmgis_fixgeometries_form)
        self.CboInput.setObjectName("CboInput")
        self.verticalLayout.addWidget(self.CboInput)
        self.LblOutput_3 = QtWidgets.QLabel(parent=hcmgis_fixgeometries_form)
        self.LblOutput_3.setObjectName("LblOutput_3")
        self.verticalLayout.addWidget(self.LblOutput_3)
        self.gridLayout = QtWidgets.QGridLayout()
        self.gridLayout.setObjectName("gridLayout")
        self.LinOutput = QtWidgets.QLineEdit(parent=hcmgis_fixgeometries_form)
        ...
        self.BtnOutput = QtWidgets.QPushButton(parent=hcmgis_fixgeometries_form)
        ...
        self.BtnOKCancel = QtWidgets.QDialogButtonBox(parent=hcmgis_fixgeometries_form)
        ...
        self.BtnOKCancel.accepted.connect(hcmgis_fixgeometries_form.accept) # type: ignore
        self.BtnOKCancel.rejected.connect(hcmgis_fixgeometries_form.reject) # type: ignore

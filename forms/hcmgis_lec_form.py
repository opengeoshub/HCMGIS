...
class Ui_hcmgis_lec_form(object):
    def setupUi(self, hcmgis_lec_form):
        ...
        hcmgis_lec_form.setWindowModality(QtCore.Qt.WindowModality.ApplicationModal)
        ...
        self.BtnApplyClose.accepted.connect(hcmgis_lec_form.accept) # type: ignore
        self.BtnApplyClose.rejected.connect(hcmgis_lec_form.reject) # type: ignore
